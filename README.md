...
cd client-library-r
R CMD build .
R CMD INSTALL ubiops_0.1.0.tar.gz
```
...
[**deployment_requests_create**](docs/deployment_requests.md#deployment_requests_create) | **POST** /projects/{project_name}/deployments/{deployment_name}/requests | Create a deployment request
...
[**deployment_version_requests_create**](docs/deployment_requests.md#deployment_version_requests_create) | **POST** /projects/{project_name}/deployments/{deployment_name}/versions/{version}/requests | Create a deployment version request
