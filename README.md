...
cd client-library-r
R CMD build .
R CMD INSTALL ubiops_0.12.0.tar.gz
```
...
[**builds_update**](docs/deployments.md#builds_update) | **PATCH** /projects/{project_name}/deployments/{deployment_name}/versions/{version}/builds/{build_id} | Update build
