...
cd client-library-r
R CMD build .
R CMD INSTALL ubiops_0.19.0.tar.gz
```
...
[**files_complete_multipart_upload**](docs/files.md#files_complete_multipart_upload) | **POST** /projects/{project_name}/buckets/{bucket_name}/files/{file}/complete-multipart-upload | Complete multipart upload
...
[**files_start_multipart_upload**](docs/files.md#files_start_multipart_upload) | **POST** /projects/{project_name}/buckets/{bucket_name}/files/{file}/start-multipart-upload | Start multipart upload
...
[**vouchers_get**](docs/organizations.md#vouchers_get) | **GET** /vouchers/{code} | Get voucher
