...
class PipelineUpdate(object):
    ...
    def __init__(self, name=None, description=None, input_type=None, input_fields=None, labels=None, default_version=None, local_vars_configuration=None):  # noqa: E501
