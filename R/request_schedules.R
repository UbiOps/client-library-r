...
#' @param data  named list of: [ name, object_type, object_name, version (optional), schedule, request_data (optional), timeout (optional), enabled (optional), description (optional), labels (optional) ]
