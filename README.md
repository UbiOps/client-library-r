...
cd client-library-r
R CMD build .
R CMD INSTALL ubiops_0.8.0.tar.gz
```
...
[**instance_types_list**](docs/organizations.md#instance_types_list) | **GET** /organizations/{organization_name}/instance-types | List instance types
...
[**organizations_usage_get**](docs/organizations.md#organizations_usage_get) | **GET** /organizations/{organization_name}/usage | Get resource usage
